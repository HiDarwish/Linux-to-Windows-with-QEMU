...
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/LTSC2021.iso https://cdn.bunkr.is/LTSC2021.MULTi5.JAN2022-3Np7ph9w.iso 
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /mediabots https://cdn.bunkr.is/LTSC2021.MULTi5.JAN2022-3Np7ph9w.iso
else
